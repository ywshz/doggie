...
public class DistributedJob implements Job {
	...
	private final String WORKER_URI = "/worker/hello";
	...
	public void execute(JobExecutionContext context)
		...
		switch (jobType){
			case HIVE : cmdPrefix="hive -f ";break;
			case SHELL : cmdPrefix="";break;
			case PYTHON : cmdPrefix="python ";break;
		}
