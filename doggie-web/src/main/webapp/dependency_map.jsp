...
<script src="${path }/resources/jquery/jquery-2.1.1.min.js"></script>
<script type="text/javascript">
	var BASE_PATH='${path }';
    var jobId = '<%= request.getParameter("id")%>';
</script>
<script type="text/javascript" src="${path }/resources/arbor/arbor.js"></script>
<script type="text/javascript" src="${path }/resources/arbor/arbor-tween.js"></script>
<script type="text/javascript" src="${path }/resources/arbor/arbor-graphics.js"></script>
<script type="text/javascript">
    (function($){
        ...
        $(document).ready(function(){
            ...
            $.post(BASE_PATH + "/job/dependency_info.do", {id: jobId}, function (res) {
